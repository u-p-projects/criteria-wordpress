<?php
// Data required for a admin product page => /admin/:product/

add_action('wp_ajax_admin_product', 'admin_product');
add_action('wp_ajax_nopriv_admin_product', 'admin_product');

function admin_product() {
  $data = new AdminProduct($_POST);
  $data->init();
...
class AdminProduct {
  ...
  private function get_featured_image() {
    $featured = get_field('featured_image', $this->product_id);
